...
const std::array<RiddleTemplate, 24> kRiddles = {{
    ...
    { "I want to be cremated as it is my last hope for...?", { "A smoking hot body", "A HELLFIRE TO BURN IN!", "A warm bed", "getting used to the Heat..maybe?" }, RiddleType::Standard },
    ...
    { "One Windmill asks another, \"What's your favorite kind of music?\" The other says...", { "\"I'm a big metal fan\"", "\"I don't listen to music\"", "\"I like Radio Music\"", "\"Listening to the Wind of Change\"" }, RiddleType::Standard },
    { "What did the sushi say to the bee?", { "Wasabi!", "WASABI!", "WAAASAABIII!", "WWAAAASSSAABIII!" }, RiddleType::AllCorrect },
    { "I asked a Frenchman if he played video games. He said...?", { "Wii", "Non", "Baguette", "Croissant" }, RiddleType::Standard },
